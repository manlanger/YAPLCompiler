/* Generated By:JavaCC: Do not edit this line. YaplScannerTokenManager.java */
package yapl;
...
/** Token Manager. */
public class YaplScannerTokenManager implements YaplScannerConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 3:
                  ...
                  break;
               case 5:
                  if ((0xfc00ff7a00000000L & l) != 0L && kind > 29)
                     kind = 29;
                  break;
               case 7:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1:
                  ...
                  break;
               case 5:
                  if ((0x3800000078000001L & l) != 0L && kind > 29)
                     kind = 29;
                  break;
               case 6:
               case 7:
...
"", null, null, null, null, null, "\43", "\45", "\50", "\51", "\52", "\53", 
"\54", "\55", "\56", "\57", "\74", "\76", "\133", "\135", "\117\162", "\101\156\144", 
"\151\156\164", "\156\145\167", "\124\162\165\145", "\106\141\154\163\145", 
"\142\157\157\154", null, null, null, null, null, null, "\74\75", "\76\75", "\75\75", "\41\75", };
...
/** Constructor. */
public YaplScannerTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public YaplScannerTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
