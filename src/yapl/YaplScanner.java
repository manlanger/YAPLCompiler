/* Generated By:JavaCC: Do not edit this line. YaplScanner.java */
package yapl;
...
public class YaplScanner implements YaplScannerConstants {
        public static void main(String args []) throws ParseException
        {
        YaplScanner parser = null;

            if(args.length == 0){
                System.out.println ("YaplParser: Reading input ...");
                parser = new YaplScanner(System.in);
            }
            else if(args.length == 1){
                System.out.println ("YaplParser: Reading the file " + args[0] + " ..." );

                try {
                  parser = new YaplScanner(new java.io.FileInputStream(args[0]));
                }
...
*/
  ...
  static public YaplScannerTokenManager token_source;
  ...
  public YaplScanner(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public YaplScanner(java.io.InputStream stream, String encoding) {
    ...
    token_source = new YaplScannerTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public YaplScanner(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public YaplScanner(YaplScannerTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(YaplScannerTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
